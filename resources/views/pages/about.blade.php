        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <img src="{{ asset('asset_fo/images/about.jpg') }}" alt="Image" class="img-fluid">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        ...
                        <img src="{{ asset('asset_fo/images/person_4.jpg') }}" alt="Image" class="img-fluid rounded mb-4">
                ...
                <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
                    <div class="team-member">
                        ...
                        <img src="{{ asset('asset_fo/images/person_5.jpg') }}" alt="Image" class="img-fluid rounded mb-4">
